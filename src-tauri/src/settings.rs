...
const COMMON: &[Spec] = &[
    ...
    s("hardcore", "Hardcore", "bool", &[], "false",
      Some("Only affects worlds generated from here on — an existing world's hardcore flag lives in its own save data and won't change retroactively. Once it's genuinely on, a player's death there is permanent.")),
